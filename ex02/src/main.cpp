...
/*   Updated: 2026/05/28 22:15:03 by rchaumei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(){
    ...
    // AForm test1;
    // AForm test2("top 10 AForm", 10, 10);
    // AForm test3;
    // AForm test4("valid signing", 150, 150);
    // AForm test5("invalid sign", 1, 1);
    ...
    // try{
    //     test1.beSigned(valid);
    // }
    // catch(const AForm::GradeTooHighException& e){
    //     std::cout<<"AForm Exception :"<<e.what()<<std::endl;
    // }
    ...
    // std::cout<<"---BUREAUCRAT SIGNING---\n";
    // signer.signForm(test4);
    // signer.signForm(test5);
    // std::cout<<test4<<std::endl;
    // std::cout<<test5<<std::endl;
    return 0;
}